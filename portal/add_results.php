    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="Science - Marks">
                <input type="text" name="p2" id="" placeholder="Maths - Marks">
                <input type="text" name="p3" id="" placeholder="English - Marks">
                <input type="text" name="p4" id="" placeholder="Social Science - Marks">
                <input type="text" name="p5" id="" placeholder="Gujarati - Marks">
